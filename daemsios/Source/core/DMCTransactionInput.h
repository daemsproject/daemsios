...
@interface DMCTransactionInput : NSObject <NSCopying>
...
// Outpoint of this input (previous hash and output index). Corresponds to COutPoint class in daemsCoind.
@property(nonatomic) DMCOutpoint* outpoint;
...
@property(nonatomic) DMCScript* signatureScript;
