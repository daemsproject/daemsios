...
//   DMCPublicKeyAddressTestnet, 
//   DMCPrivateKeyAddressTestnet, 
//   DMCScriptHashAddressTestnet.
//
@class DMCKey;
@class DMCNetwork;
@interface DMCAddress : NSObject

/*!
 * Allows subclasses to be instantiated by a call to a superclass: DMCAddress(string: "...")
 */
 ...
 */
@property(nonatomic, readonly, nonnull) DMCAddress* publicAddress;
...
@interface DMCPublicKeyAddress : DMCAddress
@end
@interface DMCPublicKeyAddressTestnet : DMCPublicKeyAddress
@end


// Private key in WIF format (5KQntKuhYWSRXNq... or L3p8oAcQTtuokSC..., base58-encoded)
@interface DMCPrivateKeyAddress : DMCAddress
...
// Returns DMCKey containing a key pair. Its public key is compressed as specified by the address.
@property(nonatomic, readonly, nonnull) DMCKey* key;
...
@end
@interface DMCPrivateKeyAddressTestnet : DMCPrivateKeyAddress
@end

// P2SH address (e.g. 3NukJ6fYZJ5Kk8bPjycAnruZkE5Q7UW7i8)
@interface DMCScriptHashAddress : DMCAddress
@end
@interface DMCScriptHashAddressTestnet : DMCScriptHashAddress
@end
