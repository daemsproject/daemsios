...
NSDictionary* DMCOpcodeForNameDictionary() {
...
NSString* DMCNameForOpcode(DMCOpcode opcode) {
    NSDictionary* dict = DMCOpcodeForNameDictionary();
...
DMCOpcode DMCOpcodeForName(NSString* opcodeName) {
    NSNumber* number = opcodeName ? DMCOpcodeForNameDictionary()[opcodeName] : nil;
...
DMCOpcode DMCOpcodeForSmallInteger(NSInteger smallInteger) {
...
NSInteger DMCSmallIntegerFromOpcode(DMCOpcode opcode) {
