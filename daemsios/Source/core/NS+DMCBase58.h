...
// For documentation look into DMCBase58.h.
// They are also used in DaemsCoin unit tests.
@interface NSString (DMCBase58)
...
@interface NSMutableData (DMCBase58)
