#import "DMCPriceSource+Tests.h"

@implementation DMCPriceSource (Tests)

+ (void) runAllTests {

    DMCPriceSourceCoindesk* coindesk = [[DMCPriceSourceCoindesk alloc] init];
    ...
    DMCPriceSourceWinkdex* winkdex = [[DMCPriceSourceWinkdex alloc] init];
    ...
    DMCPriceSourceCoinbase* coinbase = [[DMCPriceSourceCoinbase alloc] init];
    ...
    DMCPriceSourcePaymium* paymium = [[DMCPriceSourcePaymium alloc] init];
...
+ (void) validatePrice:(DMCPriceSourceResult*)result min:(double)minValue max:(double)maxValue {
