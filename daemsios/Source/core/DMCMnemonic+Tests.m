#import "DMCMnemonic+Tests.h"
#import "DMCData.h"
#import "NSData+DMCData.h"

@implementation DMCMnemonic (Tests)
...
+ (void) testStandardTestVectors {
    ...
    for (NSArray* tuple in testVectors) {
        NSData* entropy = DMCDataFromHex(tuple[0]);
        NSArray* words = [tuple[1] componentsSeparatedByString:@" "];
        NSData* seed = DMCDataFromHex(tuple[2]);
        ...
        {
            DMCMnemonic* mnemonic = [[DMCMnemonic alloc] initWithEntropy:entropy password:@"TREZOR" wordListType:DMCMnemonicWordListTypeEnglish];
            ...
            DMCMnemonic* mnemonic2 = [[DMCMnemonic alloc] initWithData:mnemonic.data];
            ...
            DMCMnemonic* mnemonic3 = [[DMCMnemonic alloc] initWithData:mnemonic.dataWithSeed];
        ...
        {
            DMCMnemonic* mnemonic = [[DMCMnemonic alloc] initWithWords:words password:@"TREZOR" wordListType:DMCMnemonicWordListTypeEnglish];
        ...
        {
            DMCMnemonic* mnemonic = [[DMCMnemonic alloc] initWithWords:words password:nil wordListType:DMCMnemonicWordListTypeEnglish];
        ...
        {
            DMCMnemonic* mnemonic = [[DMCMnemonic alloc] initWithWords:words password:@"TREZOR" wordListType:DMCMnemonicWordListTypeUnknown];
...
+ (void) testMnemonicsWithoutPassword {
    ...
    NSData* seed = DMCDataFromHex(@"a359cf47a6ddcc581f28133062dbc4cfacfbd79703e167b2a61438bf9f89efe5f2f12f8d39aea44709a5913965be93a5f805c6c614dcbfe620bceb161f0018c4");

    DMCMnemonic* mnemonic = [[DMCMnemonic alloc] initWithWords:words password:nil wordListType:DMCMnemonicWordListTypeUnknown];
