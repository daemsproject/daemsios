...
@property(nonatomic, readonly) DMCKeychain* keychain;
...
// If `password` is nil, it is treated as an empty string.
// If `wordListType` is DMCMnemonicWordListTypeUnknown, checksum is not verified.
