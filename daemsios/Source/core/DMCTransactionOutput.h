...
static uint32_t const DMCTransactionOutputIndexUnknown = 0xffffffff;
...
@interface DMCTransactionOutput : NSObject<NSCopying>
...
@property(nonatomic) DMCScript* script;
...
// Index of this output in its transaction. Default is DMCTransactionOutputIndexUnknown
