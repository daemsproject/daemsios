...
#import "DMCScript+Tests.h"
#import "DMCData.h"
#import "DMCBase58.h"
#import "DMCScriptMachine.h"
#import "DMCScript.h"
#import "DMCKey.h"
#import "DMCAddress.h"
...
@implementation DMCScript (Tests)
...
//    DMCTransaction* tx = [[DMCTransaction alloc] initWithData:DMCDataFromHex(@"")];

    DMCTransaction* tx = [[DMCTransaction alloc] initWithData:DMCDataFromHex(@"")];
//    DMCScript* redeemScript = [[DMCScript alloc] initWithData:DMCDataFromHex(@"52210378d430274f8c5ec1321338151e9f27f4c676a008bdf8638d07c0b6be9ab35c7121026a361b855808aeba02d3143b3ec884f709b24d5391c515bd4eafd69d1afae337210355e9d91d63acb15a75c1a9205fc4c0a0878778e08e0a9ca22adb0c2c33fa880153ae")];
    DMCScript* outputScript = [[DMCScript alloc] initWithAddress:[DMCAddress addressWithString:@"2NDdMCpA9to3ayTkXJQ3DvfKuSxjyRtFG5S"]];
...
//    NSLog(@"tx = %@", tx.dictionary);
    ...
    for (uint32_t i = 0; i < tx.inputs.count; i++) {
        DMCScriptMachine* sm = [[DMCScriptMachine alloc] initWithTransaction:tx inputIndex:i];
        NSError* error = nil;
        BOOL r = [sm verifyWithOutputScript:outputScript error:&error];
        if (!r) {
            NSLog(@"DMCScriptMachine error: %@", error);
        }
...
+ (void) testMultisignatureScripts {
    ...
    DMCKey* alice = [[DMCKey alloc] initWithPrivateKey:DMCHash256(DMCDataWithUTF8CString("alice"))];
    DMCKey* bob   = [[DMCKey alloc] initWithPrivateKey:DMCHash256(DMCDataWithUTF8CString("bob"))];
    DMCKey* carl  = [[DMCKey alloc] initWithPrivateKey:DMCHash256(DMCDataWithUTF8CString("carl"))];
    DMCKey* david = [[DMCKey alloc] initWithPrivateKey:DMCHash256(DMCDataWithUTF8CString("david"))];
    ...
    DMCTransaction* srcTx = [[DMCTransaction alloc] init];
    
    // Lets have a 2-of-3 multisig output.
    DMCTransactionOutput* srcTxOut = [[DMCTransactionOutput alloc] initWithValue:100 script:[[DMCScript alloc] initWithPublicKeys:pubkeys signaturesRequired:2]];
    [srcTx addOutput:srcTxOut];
    
    //NSLog(@"Script: %@", srcTxOut.script.string);

    DMCTransaction* dstTx = [[DMCTransaction alloc] init];
    
    // Add dummy output (we don't care where the coins will go)
    [dstTx addOutput:[[DMCTransactionOutput alloc] initWithValue:100]];
    
    DMCTransactionInput* dstTxIn = [[DMCTransactionInput alloc] init];
    ...
    DMCSignatureHashType hashtype = DMCSignatureHashTypeAll;
    ...
    {
        DMCScript* signatureScript = [[DMCScript alloc] init];
        ...
        DMCScriptMachine* sm = [[DMCScriptMachine alloc] initWithTransaction:dstTx inputIndex:0];
...
+ (void) testBinarySerialization {
    // Empty script
    {
        NSAssert([[[DMCScript alloc] init].data isEqual:[NSData data]], @"Default script should be empty.");
        NSAssert([[[DMCScript alloc] initWithData:[NSData data]].data isEqual:[NSData data]], @"Empty script should be empty.");
    }
    
}

+ (void) testStringSerialization {
    //NSLog(@"tx = %@", DMCHexFromData(DMCReversedData(DMCDataFromHex(@"..."))));
    
    NSData* yrashkScript = DMCDataFromHex(@"");
    
    DMCScript* script = [[DMCScript alloc] initWithData:yrashkScript];
...
+ (void) testStandardScripts {
    DMCScript *script = [[DMCScript alloc] initWithData:DMCDataFromHex(@"76a9147ab89f9fae3f8043dcee5f7b5467a0f0a6e2f7e188ac")];
    ...
    {
        NSData* simsigData = [script simulatedSignatureScriptWithOptions:DMCScriptSimulationDefault].data;
        ...
        NSData* simsigData2 = [script simulatedSignatureScriptWithOptions:DMCScriptSimulationCompressedPublicKeys].data;
    ...
    NSAssert([base58address isEqualToString:@"1CDMCGivXmHQ8ZqdPgeMfcpQNJrqTrSAcG"], @"address should be correctly decoded");
    
    DMCScript* script2 = [[DMCScript alloc] initWithAddress:[DMCAddress addressWithString:@"1CDMCGivXmHQ8ZqdPgeMfcpQNJrqTrSAcG"]];
    ...
    
    {
        ...
        {
            NSData *privkey01 = [[DMCAddress addressWithString:privKeyB58] data];
        ...
        DMCPrivateKeyAddress* pkaddr = [DMCPrivateKeyAddress addressWithString:privKeyB58];
        NSData *privkey = pkaddr.data;
        
        NSAssert([privkey isEqual:key.privateKey], @"private key should be the same");
        
        DMCKey* key2 = [[DMCKey alloc] initWithPrivateKey:privkey];
//        DMCAddress* pubkeyAddress = [DMCPublicKeyAddress addressWithData:DMCHash160(key2.publicKey)];
//        DMCAddress* privkeyAddress = [DMCPrivateKeyAddress addressWithData:key2.privateKey];
...
//    @[@"2147483647 DUP ADD", @"4294967294 NUMEQUAL", @"NUMEQUAL must be in numeric range"],
    ...
    DMCScript* script = [[DMCScript alloc] initWithString:@"2147483648 0 OP_ADD"];
    
    NSAssert(script, @"should be valid script");
    
    DMCScriptMachine* scriptMachine = [[DMCScriptMachine alloc] init];
    scriptMachine.verificationFlags = DMCScriptVerificationStrictEncoding;
    scriptMachine.inputScript = script;
    
    NSError* error = nil;
    if (![scriptMachine verifyWithOutputScript:[[DMCScript alloc] initWithString:@"OP_NOP"] error:&error]) {
//        NSLog(@"error: %@", error);
    } else {
...
DMCTransaction* BuildCreditingTransaction(DMCScript* scriptPubKey) {
    DMCTransaction* txCredit = [[DMCTransaction alloc] init];
    txCredit.version = 1;
    txCredit.lockTime = 0;
    DMCTransactionInput* txin = [[DMCTransactionInput alloc] init];
    txin.previousHash = DMCZero256();
    txin.previousIndex = 0xffffffff;
    txin.coinbaseData = [[[DMCScript new] appendOpcode:OP_0] appendOpcode:OP_0].data;
...
DMCTransaction* BuildSpendingTransaction(DMCScript* scriptSig, DMCTransaction* txCredit) {
    DMCTransaction* txSpend =[[DMCTransaction alloc] init];
    txSpend.version = 1;
    txSpend.lockTime = 0;
    DMCTransactionInput* txin = [[DMCTransactionInput alloc] init];
    ...
    DMCTransactionOutput* txout = [[DMCTransactionOutput alloc] init];
    txout.script = [[DMCScript alloc] init];
    txout.value = 0;
...
//    NSLog(@"crediting tx: %@", BuildCreditingTransaction([DMCScript new]).transactionID);
//    // add55eb99bb1f653ab822ea4177cb0f9673bcc5c2c4c729894ab0c626c8fa1e1
//    NSLog(@"spending tx:  %@", BuildSpendingTransaction([DMCScript new], BuildCreditingTransaction([DMCScript new])).transactionID);
    ...
    for (NSArray* tuple in [self validBitcoinQTScripts]) {
        ...
        DMCScript* inputScript = [[DMCScript alloc] initWithString:inputScriptString];
        if (!inputScript) {
            // for breakpoint
            inputScript = [[DMCScript alloc] initWithString:inputScriptString];
        }
        DMCScript* outputScript = [[DMCScript alloc] initWithString:outputScriptString];
        if (!outputScript) {
            // for breakpoint
            outputScript = [[DMCScript alloc] initWithString:outputScriptString];
        }
        ...
        if (![scriptMachine verifyWithOutputScript:outputScript error:&error]) {
            NSLog(@"DMCScript validation error: %@ (%@)", error, comment);
