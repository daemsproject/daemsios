...
// For documentation look into DMCData.h.
// If you link DaemsCoin library without categories enabled, nothing will break.
// This is also used in unit tests in DaemsCoin.
@interface NSData (DMCData)

// Core hash functions
- (NSData*) SHA1;
- (NSData*) SHA256;
- (NSData*) DMCHash256;  // SHA256(SHA256(self)) aka Hash or Hash256 in BitcoinQT

#if DMCDataRequiresOpenSSL
- (NSData*) RIPEMD160;
- (NSData*) DMCHash160; // RIPEMD160(SHA256(self)) aka Hash160 in BitcoinQT
#endif
