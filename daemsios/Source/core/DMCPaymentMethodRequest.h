...
extern NSInteger const DMCPaymentMethodRequestVersion1;

@interface DMCPaymentMethodRequest : NSObject
...
@property(nonatomic, readonly, nonnull) DMCPaymentMethodDetails* details;
