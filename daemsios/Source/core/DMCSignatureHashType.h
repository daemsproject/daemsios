...
#ifndef DaemsCoin_DMCSignatureHashType_h
#define DaemsCoin_DMCSignatureHashType_h
...
typedef NS_ENUM(unsigned char, DMCSignatureHashType)
{
    ...
    SIGHASH_ALL          = 1,
    DMCSignatureHashTypeAll = SIGHASH_ALL,
    ...
    SIGHASH_NONE         = 2,
    DMCSignatureHashTypeNone = SIGHASH_NONE,
    ...
    SIGHASH_SINGLE       = 3,
    DMCSignatureHashTypeSingle = SIGHASH_SINGLE,
    ...
    DMCSignatureHashTypeOutputMask = SIGHASH_OUTPUT_MASK,
    ...
    // E.g. a crowdfunding transaction with 100 DMC output can be signed independently by any number of people
    ...
    DMCSignatureHashTypeAnyoneCanPay = SIGHASH_ANYONECANPAY,
};
