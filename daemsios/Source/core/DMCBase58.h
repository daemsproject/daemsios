...
// Base58 is used for compact human-friendly representation of DaemsCoin addresses and private keys.
...
// See NS+DMCBase58.h for easy to use categories.
...
// It's mutable so you can clear it securely yourself.
char* DMCBase58CheckCStringWithData(NSData* data);
