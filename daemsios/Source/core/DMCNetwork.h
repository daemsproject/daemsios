...
@class DMCBigNumber;
@class DMCBlock;
@interface DMCNetwork : NSObject <NSCopying>

- (id) initWithName:(NSString*)name;

// Available networks

// Main DaemsCoin network, singleton instance.
+ (DMCNetwork*) mainnet;
...
@property(nonatomic) DMCBigNumber* proofOfWorkLimit;

// Array of pairs @[ @(int <height>), NSData* <hash> ] sorted by height.
@property(nonatomic) NSArray* checkpoints;


// Returns a checkpoint hash if it exists or DMC256Zero if there is no checkpoint at such height.
